...
stylelint-overrides:
	$(NODE_MODULES)/.bin/stylelint --customSyntax less --allow-empty-input 'theme/**/*.overrides' 'src/**/*.overrides'

.PHONY: stylelint-fix
stylelint-fix:	## Fix stylelint
	$(NODE_MODULES)/stylelint/bin/stylelint.js --allow-empty-input 'src/**/*.{css,less}' --fix
	$(NODE_MODULES)/.bin/stylelint --customSyntax less --allow-empty-input 'theme/**/*.overrides' 'src/**/*.overrides' --fix
