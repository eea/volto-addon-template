              ...
              steps {
                script {
                  try {
                    ...
                    sh '''docker run --rm -d --shm-size=3g --link $IMAGE_NAME-plone:plone -p :3000 --name="$IMAGE_NAME-cypress" -e "RAZZLE_INTERNAL_API_PATH=http://plone:8080/Plone" --entrypoint=make --workdir=/app/src/addons/$GIT_NAME $IMAGE_NAME-frontend start-ci'''
                    sleep(30)
